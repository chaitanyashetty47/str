  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold">Psychological Trainer Dashboard</h2>
      </div>
          ...
          {dashboardData.recentClients && dashboardData.recentClients.length > 0 ? (
            ...
            <div className="text-center py-16 text-muted-foreground bg-gray-50/50 rounded-lg">
              ...
              <p className="text-sm mt-2 text-gray-500">
                You haven't been assigned any psychological clients yet!
              </p>
            </div>
          )}
        </CardContent>
