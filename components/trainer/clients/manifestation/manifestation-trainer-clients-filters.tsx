...
interface ManifestationTrainerClientsFiltersProps {
  filters: TrainerClientsFilters;
  onFiltersChange: (filters: Partial<TrainerClientsFilters>) => void;
}

export function ManifestationTrainerClientsFilters({ filters, onFiltersChange }: ManifestationTrainerClientsFiltersProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:gap-6">
      ...
      <div className="relative flex-1">
        ...
        <Input
          placeholder="Search manifestation clients by name or email..."
