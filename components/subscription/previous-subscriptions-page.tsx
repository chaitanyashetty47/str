...
import { PreviousSubscriptions } from '@/components/subscription/previous-subscriptions';
import { Skeleton } from '@/components/ui/skeleton';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { AlertCircle, RefreshCw, History } from 'lucide-react';
import { Button } from '@/components/ui/button';

interface PreviousSubscriptionsPageProps {
  userId: string;
}

export function PreviousSubscriptionsPage({ userId }: PreviousSubscriptionsPageProps) {
